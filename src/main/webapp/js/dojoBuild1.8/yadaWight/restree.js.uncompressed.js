		    ...
		    getTree: function(){
		    	...
		    	return Tree({
		            ...
		            onClick: function(item){
		            	if(item.root == true){
		            		registry.byId(showId).set("href", showUrl+ "&menuResId=&pmenuResId=" + item.id + '&time=' + new Date().getTime());
		            	}else{
		            		registry.byId(showId).set("href", showUrl+"&menuResId=" + item.menuResId + "&pmenuResId=" + item.pmenuResId + '&time=' + new Date().getTime());
		            	}
					},
