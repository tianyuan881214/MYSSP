...
var SimpleTable = function(formId,pageNumber,pageSize,sortColumns,pageNumberKey,pageSizeKey,sortColumnsKey) {
	...
	this.pageNumberKey = pageNumberKey || 's_pageNumber';
	this.pageSizeKey = pageSizeKey || 's_pageSize';
...
//		$('#'+this.form).append(params);
		...
		var param1 = pair(this.pageNumberKey,this.pageNumber);
//		var param2 = pair(this.pageSizeKey,this.pageSize);
		var param3 = pair(this.sortColumnsKey,this.sortColumns);
		var fromDom = document.getElementById(this.form);
		
		fromDom.appendChild(param1);
//		fromDom.appendChild(param2);
		fromDom.appendChild(param3);
//		document.getElementById(this.form).append(params);
		document.getElementById('eXtremeTable').style.visibility='hidden';
		SimpleTableUtils.fireSubmit(this.form);
//		document.getElementById('doing').style.visibility='visible';
		
		
//		$("div[class='eXtremeTable']")[0].style.visibility='hidden';
	},
