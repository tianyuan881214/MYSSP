dsy.add("0_0_4",["\u8386\u7530\u5e02","\u4ed9\u6e38\u53bf"]);
dsy.add("0_0_5",["\u5b89\u6eaa\u53bf","\u5fb7\u5316\u53bf","\u60e0\u5b89\u53bf","\u91d1\u95e8\u53bf","\u664b\u6c5f\u5e02","\u5357\u5b89\u5e02","\u6cc9\u5dde\u5e02","\u77f3\u72ee\u5e02","\u6c38\u6625\u53bf"]);
dsy.add("0_0_6",["\u5927\u7530\u53bf","\u5efa\u5b81\u53bf","\u5c06\u4e50\u53bf","\u660e\u6eaa\u53bf","\u5b81\u5316\u53bf","\u6e05\u6d41\u53bf","\u4e09\u660e\u5e02","\u6c99\u53bf","\u6cf0\u5b81\u53bf","\u6c38\u5b89\u5e02","\u5c24\u6eaa\u53bf"]);
dsy.add("0_0_7",["\u53a6\u95e8\u5e02"]);
dsy.add("0_0_8",["\u957f\u6cf0\u53bf","\u4e1c\u5c71\u53bf","\u534e\u5b89\u53bf","\u9f99\u6d77\u5e02","\u5357\u9756\u53bf","\u5e73\u548c\u53bf","\u4e91\u9704\u53bf","\u6f33\u6d66\u53bf","\u6f33\u5dde\u5e02","\u8bcf\u5b89\u53bf"]);
...
function initAdd(province,city,section)
{
	var provinceObj = document.getElementById(s[0]);
	var cityObj = document.getElementById(s[1]);
	var sectionObj = document.getElementById(s[2]);
	var provinceIndex = 0;
	var cityIndex = 0;
	var sectionIndex = 0;
	//\u6839\u636e\u53c2\u6570\u8bbe\u7f6e\u7701\u7684\u9009\u62e9\u9879.
	for(provinceIndex=0;provinceIndex<provinceObj.length;provinceIndex++)
	{
		if(provinceObj.options[provinceIndex].value == province)
		{
			provinceObj.options[provinceIndex].selected=true;
			change(1);
			break;
		}
	}
	//\u6839\u636e\u53c2\u6570\u8bbe\u7f6e\u5e02\u7684\u9009\u62e9\u9879.
	for(cityIndex=0;cityIndex<cityObj.length;cityIndex++)
	{
		if(cityObj.options[cityIndex].value == city)
		{
			cityObj.options[cityIndex].selected=true;
			change(2);
			break;
		}
	}
	//\u6839\u636e\u53c2\u6570\u8bbe\u7f6e\u533a\u53bf\u7684\u9009\u62e9\u9879.
	for(sectionIndex=0;sectionIndex<sectionObj.length;sectionIndex++)
	{
		if(sectionObj.options[sectionIndex].value == section)
		{
			sectionObj.options[sectionIndex].selected=true;
			break;
		}
	}
}
