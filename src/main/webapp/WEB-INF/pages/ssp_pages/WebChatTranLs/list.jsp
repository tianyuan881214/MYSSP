    ...
    <div id="content">
        ...
        <div class="biao">
            <table class="grid">
                ...
                <tr>
                    <td class="lgridlist" colspan="4">微信流水</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input onkeyup="this.value=this.value.replace(/\D/g,'')"
                               onafterpaste="this.value=this.value.replace(/\D/g,'')"
                                type="text" value="${query.outTradeNo}" id="outTradeNo" name="outTradeNo"
                               maxlength="40" class=""/>
                    </td>
            ...
            <table class="b">
                <tr align="center">
                    ...
                    <td><input type="submit" style="width: 80px" value="查询"
                               onclick="if (checkOnSubmit(this))
                               { getReferenceForm(this).action='list.do';}
                               else {return checkOnSubmit();}"/></td>
                   <%-- <td>
                ...
                <table class="grid its">
                    ...
                    <c:forEach items="${page.result}" var="item" varStatus="status">
                        <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
                          ...
                          <td align="center"><c:out value='${item.mchId}'/>&nbsp;</td>
                          <td align="center"><c:out value='${item.outTradeNo}'/>&nbsp;</td>
                           <td align="center"><c:out value='${item.authCode}'/>&nbsp;</td>
                           ...
                           <td align="center"><c:out value='${item.merchantCname}'/>&nbsp;</td>
                            <c:choose>
                             ...
                             <td align="center"><c:out value='${item.operatorId}'/>&nbsp;</td>
                            <%-- <td align="center"><c:out value='${item.refundFlag}'/>&nbsp;</td>
                             <td align="center"><c:out value='${item.returnCode}'/>&nbsp;</td>--%>
