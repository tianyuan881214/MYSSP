...
<div id="dqwz">
    <p>
        当前位置：业务管理&nbsp;〉&nbsp;<%=SysPara.TABLE_ALIAS%>管理
    </p>
    <p class="line"></p>
</div>
    ...
    <div id="content">
        ...
        <div class="biao">
            <table class="grid">
                ...
                <tr>
                    <td class="lgridlist" colspan="4"><%=SysPara.TABLE_ALIAS%>查询</td>
                </tr>
             <%--   <tr>
                    <td class="crosscolor_td"><%=SysPara.%>
                    </td>
                    <td>
        ...
        <div class="form">
            <div id="eXtremeTable" class="eXtremeTable">
                <table class="grid its">
                    ...
                    <tr>
                        <th>操作</th>
                        <th><%=SysPara.PARA_ID%></th>
                        <th><%=SysPara.PARA_VALUE%></th>
                        <th><%=SysPara.REMARK%></th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <c:forEach items="${page.result}" var="item" varStatus="status">
                        <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
                            <td align="center">
                                <a href="edit.do?paraId=${item.paraId}">编辑</a>
                            </td>
                            <td align="center"><c:out value='${item.paraId}'/>&nbsp;</td>
                            <td align="center"><c:out value='${item.paraValue}'/>&nbsp;</td>
