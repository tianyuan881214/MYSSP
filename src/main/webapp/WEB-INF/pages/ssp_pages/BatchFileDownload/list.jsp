    ...
    <div id="content">
        ...
        <div class="biao">
            <table class="grid">
                ...
                <tr>
                    <td class="lgridlist" colspan="4">银行入账文件下载</td>
                </tr>
                <tr>
                ...
                <table class="grid its">
                    ...
                    <c:if test="${files!=''}">
                        <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
                            <td align="center">
                                <a href="${ctx}/batchfiledownload/download.do?fileName=${files}&<mytag:params includes="s_*" type="queryStringUtf"/>">下载>></a>
                                &nbsp;|&nbsp;
