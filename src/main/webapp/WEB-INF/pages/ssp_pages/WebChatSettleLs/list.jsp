    ...
    <div id="content">
        ...
        <div class="biao">
            <table class="grid">
                ...
                <tr>
                    <td class="lgridlist" colspan="4">微信清算报表</td>
                </tr>
                <tr>
                ...
                <table class="grid its">
                    ...
                    <c:forEach items="${page.result}" var="item" varStatus="status">
                        <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
                            ...
                            <td align="center"><c:out value='${item.subMerchantId}'/>&nbsp;</td>
                            ...
                            <td align="center"><c:out value='${item.tranStart}'/>&nbsp;</td>
                            ...
                            <td align="center"><c:out value='${item.webFee}'/>&nbsp;</td>
