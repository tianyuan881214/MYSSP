    ...
    <td bgcolor="BEE9FD"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="15" cellspacing="1">
          <tr>
            <td width="20%" bgcolor="E0F4FF"><div align="center"><img src="baocuo12.gif"></div></td>
            <td width="80%" bgcolor="E0F4FF"><span class="f14"><strong>404异常：</strong>请求的资源无法被服务器定位。</span></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
